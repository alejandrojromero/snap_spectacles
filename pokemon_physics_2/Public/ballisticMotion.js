...
function onUpdate() {
    ...
    if(script.ball.getTransform().getWorldPosition().distance(script.pokemon.getTransform().getWorldPosition()) <= 100){
        ...
        //Destroy pokemon after animation delay
...
//    *********WRAP THIS INTO RESET METHOD**********
//    var index = ranNum(pokemonArray.length)
//    
//    for (var i = 0; i < pokemonArray.length; i++){
//        pokemonArray[i].enabled = false;
//    }
//    pokemonArray[index].enabled = true;
//    
//    script.finalText.enabled = false;
//    script.pokemon.enabled = true;
//    script.ball2.enabled = true;
//    script.effects.enabled = false;
//    script.IdleAnimation.enabled = true;
    print("running")
}
